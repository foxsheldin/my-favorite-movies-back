...
export class Init1683110974719 implements MigrationInterface {
    name = 'Init1683110974719'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "favorite_movies" ("userId" uuid NOT NULL, "movieId" numeric NOT NULL, "watched" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_ad08da426f2a5c6c7ba76a193ad" PRIMARY KEY ("userId"))`);
